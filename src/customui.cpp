...
namespace CustomUI {
    bool TextObject::create() {
        ...
        auto* n = createcsstr(name);
        gameObj = RET_DEFAULT_UNLESS(New("UnityEngine", "GameObject", n));
    ...
    static uintptr_t findDataSize(Il2CppObject* downloadHandler) {
    ...
    bool RawImageObject::textureWebRequestComplete(RawImageObject* obj, Il2CppObject* asyncOp) {
        ...
        auto* n = createcsstr("RandomImage");
        obj->gameObj = RET_0_UNLESS(New("UnityEngine", "GameObject", n).value_or(nullptr));
